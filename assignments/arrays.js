...
let lastCar = function() {
    ...
    return(inventory[last].car_make + " " + inventory[last].car_model);
};
console.log(lastCar());
...
let carModels = function () {
    ...
    for (let i = 0; i < inventory.length; i++) {
        sort.push(inventory[i].car_model);        
...
let stringyModel = JSON.stringify(BMWAndAudi);

JSON.stringify(BMWAndAudi);

console.log(stringyModel);
